        ...
        <div id="contents">
               <div class="sub-title-area">
                ...
                <table class="basic_write">
                    ...
                    <form name="board_form" method="post" action="board_db_insert.php" enctype="multipart/form-data">
					<tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" title="성명" name="name" id="name" class="name_txt" placeholder="성명 *"></td>
                    </tr>
                 
                    <tr>
                        <th>첨부파일</th>
                        <td>
                            <input type="file" title="첨부파일" name="upfile" id="upfile" class="name_txt">
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="btn_area">
					...
					<a href="#" class="btn_blue_line" onclick="location.href='list.php'">취소</a>
                </div>
                </form>
        </div>
        <!-- CONTENTS @ -->
